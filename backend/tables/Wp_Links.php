...
use Backend\Tables\Traits\Wp_Links_Columns;
...
class Wp_Links extends Rest implements iRestSinglePrimaryKey
{
    ...
    **/
    public const PRIMARY = 'carbon_wp_links.link_id';
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in carbon_wp_links. 
    ...
    **/
    public const LINK_ID = 'carbon_wp_links.link_id'; 

    public const LINK_URL = 'carbon_wp_links.link_url'; 

    public const LINK_NAME = 'carbon_wp_links.link_name'; 

    public const LINK_IMAGE = 'carbon_wp_links.link_image'; 

    public const LINK_TARGET = 'carbon_wp_links.link_target'; 

    public const LINK_DESCRIPTION = 'carbon_wp_links.link_description'; 

    public const LINK_VISIBLE = 'carbon_wp_links.link_visible'; 

    public const LINK_OWNER = 'carbon_wp_links.link_owner'; 

    public const LINK_RATING = 'carbon_wp_links.link_rating'; 

    public const LINK_UPDATED = 'carbon_wp_links.link_updated'; 

    public const LINK_REL = 'carbon_wp_links.link_rel'; 

    public const LINK_NOTES = 'carbon_wp_links.link_notes'; 

    public const LINK_RSS = 'carbon_wp_links.link_rss'; 
    ...
    **/
    public const PDO_VALIDATION = [
        self::LINK_ID => [ self::MYSQL_TYPE => 'bigint unsigned', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => true, self::SKIP_COLUMN_IN_POST => true ],
        self::LINK_URL => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '255', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::LINK_NAME => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '255', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::LINK_IMAGE => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '255', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::LINK_TARGET => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '25', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::LINK_DESCRIPTION => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '255', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::LINK_VISIBLE => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '20', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"Y"' ],
        self::LINK_OWNER => [ self::MYSQL_TYPE => 'bigint unsigned', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"1"' ],
        self::LINK_RATING => [ self::MYSQL_TYPE => 'int', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0"' ],
        self::LINK_UPDATED => [ self::MYSQL_TYPE => 'datetime', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0000-00-00 00:00:00"' ],
        self::LINK_REL => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '255', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::LINK_NOTES => [ self::MYSQL_TYPE => 'mediumtext', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::LINK_RSS => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '255', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
    ];
    ...
    **/
     ...
     *              ],
     *              self::LINK_ID => [
     *                  [self::class => 'disallowPublicAccess', self::LINK_ID]
     *              ],
     *              self::LINK_URL => [
     *                  [self::class => 'disallowPublicAccess', self::LINK_URL]
     *              ],
     *              self::LINK_NAME => [
     *                  [self::class => 'disallowPublicAccess', self::LINK_NAME]
     *              ],
     *              self::LINK_IMAGE => [
     *                  [self::class => 'disallowPublicAccess', self::LINK_IMAGE]
     *              ],
     *              self::LINK_TARGET => [
     *                  [self::class => 'disallowPublicAccess', self::LINK_TARGET]
     *              ],
     *              self::LINK_DESCRIPTION => [
     *                  [self::class => 'disallowPublicAccess', self::LINK_DESCRIPTION]
     *              ],
     *              self::LINK_VISIBLE => [
     *                  [self::class => 'disallowPublicAccess', self::LINK_VISIBLE]
     *              ],
     *              self::LINK_OWNER => [
     *                  [self::class => 'disallowPublicAccess', self::LINK_OWNER]
     *              ],
     *              self::LINK_RATING => [
     *                  [self::class => 'disallowPublicAccess', self::LINK_RATING]
     *              ],
     *              self::LINK_UPDATED => [
     *                  [self::class => 'disallowPublicAccess', self::LINK_UPDATED]
     *              ],
     *              self::LINK_REL => [
     *                  [self::class => 'disallowPublicAccess', self::LINK_REL]
     *              ],
     *              self::LINK_NOTES => [
     *                  [self::class => 'disallowPublicAccess', self::LINK_NOTES]
     *              ],
     *              self::LINK_RSS => [
     *                  [self::class => 'disallowPublicAccess', self::LINK_RSS]
     *              ],
     *          ],    

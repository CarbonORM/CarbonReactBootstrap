...
use Backend\Tables\Traits\Wp_Commentmeta_Columns;
...
class Wp_Commentmeta extends Rest implements iRestSinglePrimaryKey
{
    ...
    **/
    public const PRIMARY = 'carbon_wp_commentmeta.meta_id';
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in carbon_wp_commentmeta. 
    ...
    **/
    public const META_ID = 'carbon_wp_commentmeta.meta_id'; 

    public const COMMENT_ID = 'carbon_wp_commentmeta.comment_id'; 

    public const META_KEY = 'carbon_wp_commentmeta.meta_key'; 

    public const META_VALUE = 'carbon_wp_commentmeta.meta_value'; 
    ...
    **/
    public const PDO_VALIDATION = [
        ...
        self::COMMENT_ID => [ self::MYSQL_TYPE => 'bigint unsigned', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0"' ],

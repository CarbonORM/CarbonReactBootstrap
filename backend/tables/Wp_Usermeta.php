...
use Backend\Tables\Traits\Wp_Usermeta_Columns;
...
class Wp_Usermeta extends Rest implements iRestSinglePrimaryKey
{
    ...
    **/
    public const PRIMARY = 'carbon_wp_usermeta.umeta_id';
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in carbon_wp_usermeta. 
    ...
    **/
    public const UMETA_ID = 'carbon_wp_usermeta.umeta_id'; 

    public const USER_ID = 'carbon_wp_usermeta.user_id'; 

    public const META_KEY = 'carbon_wp_usermeta.meta_key'; 

    public const META_VALUE = 'carbon_wp_usermeta.meta_value'; 
    ...
    **/
    public const PDO_VALIDATION = [
        self::UMETA_ID => [ self::MYSQL_TYPE => 'bigint unsigned', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => true, self::SKIP_COLUMN_IN_POST => true ],
    ...
    **/
     ...
     *              ],
     *              self::UMETA_ID => [
     *                  [self::class => 'disallowPublicAccess', self::UMETA_ID]
     *              ],
     *              self::USER_ID => [

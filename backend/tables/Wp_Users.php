...
use Backend\Tables\Traits\Wp_Users_Columns;
...
class Wp_Users extends Rest implements iRestSinglePrimaryKey
{
    ...
    **/
    public const PRIMARY = 'carbon_wp_users.ID';
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in carbon_wp_users. 
    ...
    **/
    public const ID = 'carbon_wp_users.ID'; 

    public const USER_LOGIN = 'carbon_wp_users.user_login'; 

    public const USER_PASS = 'carbon_wp_users.user_pass'; 

    public const USER_NICENAME = 'carbon_wp_users.user_nicename'; 

    public const USER_EMAIL = 'carbon_wp_users.user_email'; 

    public const USER_URL = 'carbon_wp_users.user_url'; 

    public const USER_REGISTERED = 'carbon_wp_users.user_registered'; 

    public const USER_ACTIVATION_KEY = 'carbon_wp_users.user_activation_key'; 

    public const USER_STATUS = 'carbon_wp_users.user_status'; 

    public const DISPLAY_NAME = 'carbon_wp_users.display_name'; 
    ...
    **/
    public const PDO_VALIDATION = [
        ...
        self::USER_LOGIN => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '60', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::USER_PASS => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '255', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::USER_NICENAME => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '50', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::USER_EMAIL => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '100', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::USER_URL => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '100', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::USER_REGISTERED => [ self::MYSQL_TYPE => 'datetime', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0000-00-00 00:00:00"' ],
        self::USER_ACTIVATION_KEY => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '255', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::USER_STATUS => [ self::MYSQL_TYPE => 'int', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0"' ],
        self::DISPLAY_NAME => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '250', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
    ];
    ...
    **/
     ...
     *              ],
     *              self::USER_LOGIN => [
     *                  [self::class => 'disallowPublicAccess', self::USER_LOGIN]
     *              ],
     *              self::USER_PASS => [
     *                  [self::class => 'disallowPublicAccess', self::USER_PASS]
     *              ],
     *              self::USER_NICENAME => [
     *                  [self::class => 'disallowPublicAccess', self::USER_NICENAME]
     *              ],
     *              self::USER_EMAIL => [
     *                  [self::class => 'disallowPublicAccess', self::USER_EMAIL]
     *              ],
     *              self::USER_URL => [
     *                  [self::class => 'disallowPublicAccess', self::USER_URL]
     *              ],
     *              self::USER_REGISTERED => [
     *                  [self::class => 'disallowPublicAccess', self::USER_REGISTERED]
     *              ],
     *              self::USER_ACTIVATION_KEY => [
     *                  [self::class => 'disallowPublicAccess', self::USER_ACTIVATION_KEY]
     *              ],
     *              self::USER_STATUS => [
     *                  [self::class => 'disallowPublicAccess', self::USER_STATUS]
     *              ],
     *              self::DISPLAY_NAME => [
     *                  [self::class => 'disallowPublicAccess', self::DISPLAY_NAME]
     *              ],
     *          ],    

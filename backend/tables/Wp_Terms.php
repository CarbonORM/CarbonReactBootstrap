...
use Backend\Tables\Traits\Wp_Terms_Columns;
...
class Wp_Terms extends Rest implements iRestSinglePrimaryKey
{
    ...
    **/
    public const PRIMARY = 'carbon_wp_terms.term_id';
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in carbon_wp_terms. 
    ...
    **/
    public const TERM_ID = 'carbon_wp_terms.term_id'; 

    public const NAME = 'carbon_wp_terms.name'; 

    public const SLUG = 'carbon_wp_terms.slug'; 

    public const TERM_GROUP = 'carbon_wp_terms.term_group'; 
    ...
    **/
    public const PDO_VALIDATION = [
        self::TERM_ID => [ self::MYSQL_TYPE => 'bigint unsigned', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => true, self::SKIP_COLUMN_IN_POST => true ],
        self::NAME => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '200', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::SLUG => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '200', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::TERM_GROUP => [ self::MYSQL_TYPE => 'bigint', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0"' ],
    ];
    ...
    **/
     ...
     *              ],
     *              self::NAME => [
     *                  [self::class => 'disallowPublicAccess', self::NAME]
     *              ],
     *              self::SLUG => [
     *                  [self::class => 'disallowPublicAccess', self::SLUG]
     *              ],
     *              self::TERM_GROUP => [
     *                  [self::class => 'disallowPublicAccess', self::TERM_GROUP]
     *              ],
     *          ],    

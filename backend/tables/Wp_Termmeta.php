...
use Backend\Tables\Traits\Wp_Termmeta_Columns;
...
class Wp_Termmeta extends Rest implements iRestSinglePrimaryKey
{
    ...
    **/
    public const PRIMARY = 'carbon_wp_termmeta.meta_id';
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in carbon_wp_termmeta. 
    ...
    **/
    public const META_ID = 'carbon_wp_termmeta.meta_id'; 

    public const TERM_ID = 'carbon_wp_termmeta.term_id'; 

    public const META_KEY = 'carbon_wp_termmeta.meta_key'; 

    public const META_VALUE = 'carbon_wp_termmeta.meta_value'; 
    ...
    **/
    public const PDO_VALIDATION = [
        self::META_ID => [ self::MYSQL_TYPE => 'bigint unsigned', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => true, self::SKIP_COLUMN_IN_POST => true ],
        ...
        self::META_KEY => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => false, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '255', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => null ],
        self::META_VALUE => [ self::MYSQL_TYPE => 'longtext', self::NOT_NULL => false, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
    ];
    ...
    **/
     ...
     *              ],
     *              self::META_ID => [
     *                  [self::class => 'disallowPublicAccess', self::META_ID]
     *              ],
     *              self::TERM_ID => [
     *                  [self::class => 'disallowPublicAccess', self::TERM_ID]
     *              ],
     *              self::META_KEY => [
     *                  [self::class => 'disallowPublicAccess', self::META_KEY]
     *              ],
     *              self::META_VALUE => [
     *                  [self::class => 'disallowPublicAccess', self::META_VALUE]
     *              ],
     *          ],    

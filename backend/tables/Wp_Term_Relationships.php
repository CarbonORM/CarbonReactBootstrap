...
use Backend\Tables\Traits\Wp_Term_Relationships_Columns;
...
class Wp_Term_Relationships extends Rest implements iRestMultiplePrimaryKeys
{
    ...
    **/
    public const PRIMARY = ['carbon_wp_term_relationships.object_id','carbon_wp_term_relationships.term_taxonomy_id',
    ];
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in carbon_wp_term_relationships. 
    ...
    **/
    public const OBJECT_ID = 'carbon_wp_term_relationships.object_id'; 

    public const TERM_TAXONOMY_ID = 'carbon_wp_term_relationships.term_taxonomy_id'; 

    public const TERM_ORDER = 'carbon_wp_term_relationships.term_order'; 
    ...
    **/
    public const PDO_VALIDATION = [
        self::OBJECT_ID => [ self::MYSQL_TYPE => 'bigint unsigned', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0"' ],
        self::TERM_TAXONOMY_ID => [ self::MYSQL_TYPE => 'bigint unsigned', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0"' ],
        self::TERM_ORDER => [ self::MYSQL_TYPE => 'int', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0"' ],
    ];
    ...
    **/
     ...
     *              ],
     *              self::OBJECT_ID => [
     *                  [self::class => 'disallowPublicAccess', self::OBJECT_ID]
     *              ],
     *              self::TERM_TAXONOMY_ID => [
     *                  [self::class => 'disallowPublicAccess', self::TERM_TAXONOMY_ID]
     *              ],
     *              self::TERM_ORDER => [
     *                  [self::class => 'disallowPublicAccess', self::TERM_ORDER]
     *              ],
     *          ],    
...
MYSQL;
    ...
    * @return bool
    */
    public static function get(array|null &$return, array $primary = null, array $argv = []): bool
    {
        return self::select($return, $argv, $primary);
    }
    ...
    */
    ...
    {
        return self::updateReplace($returnUpdated, $argv, $primary);
    }
    ...
    */
    ...
    {
        return self::remove($remove, $argv, $primary);
    }

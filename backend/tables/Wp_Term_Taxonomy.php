...
use Backend\Tables\Traits\Wp_Term_Taxonomy_Columns;
...
class Wp_Term_Taxonomy extends Rest implements iRestSinglePrimaryKey
{
    ...
    **/
    public const PRIMARY = 'carbon_wp_term_taxonomy.term_taxonomy_id';
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in carbon_wp_term_taxonomy. 
    ...
    **/
    public const TERM_TAXONOMY_ID = 'carbon_wp_term_taxonomy.term_taxonomy_id'; 

    public const TERM_ID = 'carbon_wp_term_taxonomy.term_id'; 

    public const TAXONOMY = 'carbon_wp_term_taxonomy.taxonomy'; 

    public const DESCRIPTION = 'carbon_wp_term_taxonomy.description'; 

    public const PARENT = 'carbon_wp_term_taxonomy.parent'; 

    public const COUNT = 'carbon_wp_term_taxonomy.count'; 
    ...
    **/
    public const PDO_VALIDATION = [
        self::TERM_TAXONOMY_ID => [ self::MYSQL_TYPE => 'bigint unsigned', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => true, self::SKIP_COLUMN_IN_POST => true ],
        self::TERM_ID => [ self::MYSQL_TYPE => 'bigint unsigned', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0"' ],
        self::TAXONOMY => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '32', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::DESCRIPTION => [ self::MYSQL_TYPE => 'longtext', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::PARENT => [ self::MYSQL_TYPE => 'bigint unsigned', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0"' ],
        self::COUNT => [ self::MYSQL_TYPE => 'bigint', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0"' ],
    ];
    ...
    **/
     ...
     *                  [self::class => 'disallowPublicAccess', self::TERM_TAXONOMY_ID]
     *              ],
     *              self::TERM_ID => [
     *                  [self::class => 'disallowPublicAccess', self::TERM_ID]
     *              ],
     *              self::TAXONOMY => [
     *                  [self::class => 'disallowPublicAccess', self::TAXONOMY]
     *              ],
     *              self::DESCRIPTION => [
     *                  [self::class => 'disallowPublicAccess', self::DESCRIPTION]
     *              ],
     *              self::PARENT => [
     *                  [self::class => 'disallowPublicAccess', self::PARENT]
     *              ],
     *              self::COUNT => [
     *                  [self::class => 'disallowPublicAccess', self::COUNT]
     *              ],
     *          ],    

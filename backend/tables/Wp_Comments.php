...
use Backend\Tables\Traits\Wp_Comments_Columns;
...
class Wp_Comments extends Rest implements iRestSinglePrimaryKey
{
    ...
    **/
    public const PRIMARY = 'carbon_wp_comments.comment_ID';
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in carbon_wp_comments. 
    ...
    **/
    public const COMMENT_ID = 'carbon_wp_comments.comment_ID'; 

    public const COMMENT_POST_ID = 'carbon_wp_comments.comment_post_ID'; 

    public const COMMENT_AUTHOR = 'carbon_wp_comments.comment_author'; 

    public const COMMENT_AUTHOR_EMAIL = 'carbon_wp_comments.comment_author_email'; 

    public const COMMENT_AUTHOR_URL = 'carbon_wp_comments.comment_author_url'; 

    public const COMMENT_AUTHOR_IP = 'carbon_wp_comments.comment_author_IP'; 

    public const COMMENT_DATE = 'carbon_wp_comments.comment_date'; 

    public const COMMENT_DATE_GMT = 'carbon_wp_comments.comment_date_gmt'; 

    public const COMMENT_CONTENT = 'carbon_wp_comments.comment_content'; 

    public const COMMENT_KARMA = 'carbon_wp_comments.comment_karma'; 

    public const COMMENT_APPROVED = 'carbon_wp_comments.comment_approved'; 

    public const COMMENT_AGENT = 'carbon_wp_comments.comment_agent'; 

    public const COMMENT_TYPE = 'carbon_wp_comments.comment_type'; 

    public const COMMENT_PARENT = 'carbon_wp_comments.comment_parent'; 

    public const USER_ID = 'carbon_wp_comments.user_id'; 
    ...
    **/
    public const PDO_VALIDATION = [
        self::COMMENT_ID => [ self::MYSQL_TYPE => 'bigint unsigned', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => true, self::SKIP_COLUMN_IN_POST => true ],
        self::COMMENT_POST_ID => [ self::MYSQL_TYPE => 'bigint unsigned', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0"' ],
        self::COMMENT_AUTHOR => [ self::MYSQL_TYPE => 'tinytext', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::COMMENT_AUTHOR_EMAIL => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '100', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::COMMENT_AUTHOR_URL => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '200', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::COMMENT_AUTHOR_IP => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '100', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::COMMENT_DATE => [ self::MYSQL_TYPE => 'datetime', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0000-00-00 00:00:00"' ],
        self::COMMENT_DATE_GMT => [ self::MYSQL_TYPE => 'datetime', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0000-00-00 00:00:00"' ],
        self::COMMENT_CONTENT => [ self::MYSQL_TYPE => 'text', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::COMMENT_KARMA => [ self::MYSQL_TYPE => 'int', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0"' ],
        self::COMMENT_APPROVED => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '20', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"1"' ],
        self::COMMENT_AGENT => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '255', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::COMMENT_TYPE => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '20', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"comment"' ],
        self::COMMENT_PARENT => [ self::MYSQL_TYPE => 'bigint unsigned', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0"' ],
        self::USER_ID => [ self::MYSQL_TYPE => 'bigint unsigned', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0"' ],
    ];
    ...
    **/
     ...
     *                  [self::class => 'disallowPublicAccess', self::COMMENT_POST_ID]
     *              ],
     *              self::COMMENT_AUTHOR => [
     *                  [self::class => 'disallowPublicAccess', self::COMMENT_AUTHOR]
     *              ],
     *              self::COMMENT_AUTHOR_EMAIL => [
     *                  [self::class => 'disallowPublicAccess', self::COMMENT_AUTHOR_EMAIL]
     *              ],
     *              self::COMMENT_AUTHOR_URL => [
     *                  [self::class => 'disallowPublicAccess', self::COMMENT_AUTHOR_URL]
     *              ],
     *              self::COMMENT_AUTHOR_IP => [
     *                  [self::class => 'disallowPublicAccess', self::COMMENT_AUTHOR_IP]
     *              ],
     *              self::COMMENT_DATE => [
     *                  [self::class => 'disallowPublicAccess', self::COMMENT_DATE]
     *              ],
     *              self::COMMENT_DATE_GMT => [
     *                  [self::class => 'disallowPublicAccess', self::COMMENT_DATE_GMT]
     *              ],
     *              self::COMMENT_CONTENT => [
     *                  [self::class => 'disallowPublicAccess', self::COMMENT_CONTENT]
     *              ],
     *              self::COMMENT_KARMA => [
     *                  [self::class => 'disallowPublicAccess', self::COMMENT_KARMA]
     *              ],
     *              self::COMMENT_APPROVED => [
     *                  [self::class => 'disallowPublicAccess', self::COMMENT_APPROVED]
     *              ],
     *              self::COMMENT_AGENT => [
     *                  [self::class => 'disallowPublicAccess', self::COMMENT_AGENT]
     *              ],
     *              self::COMMENT_TYPE => [
     *                  [self::class => 'disallowPublicAccess', self::COMMENT_TYPE]
     *              ],
     *              self::COMMENT_PARENT => [
     *                  [self::class => 'disallowPublicAccess', self::COMMENT_PARENT]
     *              ],
     *              self::USER_ID => [

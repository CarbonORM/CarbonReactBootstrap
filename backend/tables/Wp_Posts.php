...
use Backend\Tables\Traits\Wp_Posts_Columns;
...
{
    use Wp_Posts_Columns;
    
    public const CLASS_NAME = 'Wp_Posts';
    
    public const CLASS_NAMESPACE = 'Backend\Tables\\';
    
    public const TABLE_NAME = 'carbon_wp_posts';
    ...
    **/
    public const PRIMARY = 'carbon_wp_posts.ID';
    ...
    **/
    public const AUTO_INCREMENT_PRIMARY_KEY = true;
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in carbon_wp_posts. 
    ...
    **/
    public const ID = 'carbon_wp_posts.ID'; 

    public const POST_AUTHOR = 'carbon_wp_posts.post_author'; 

    public const POST_DATE = 'carbon_wp_posts.post_date'; 

    public const POST_DATE_GMT = 'carbon_wp_posts.post_date_gmt'; 

    public const POST_CONTENT = 'carbon_wp_posts.post_content'; 

    public const POST_TITLE = 'carbon_wp_posts.post_title'; 

    public const POST_EXCERPT = 'carbon_wp_posts.post_excerpt'; 

    public const POST_STATUS = 'carbon_wp_posts.post_status'; 

    public const COMMENT_STATUS = 'carbon_wp_posts.comment_status'; 

    public const PING_STATUS = 'carbon_wp_posts.ping_status'; 

    public const POST_PASSWORD = 'carbon_wp_posts.post_password'; 

    public const POST_NAME = 'carbon_wp_posts.post_name'; 

    public const TO_PING = 'carbon_wp_posts.to_ping'; 

    public const PINGED = 'carbon_wp_posts.pinged'; 

    public const POST_MODIFIED = 'carbon_wp_posts.post_modified'; 

    public const POST_MODIFIED_GMT = 'carbon_wp_posts.post_modified_gmt'; 

    public const POST_CONTENT_FILTERED = 'carbon_wp_posts.post_content_filtered'; 

    public const POST_PARENT = 'carbon_wp_posts.post_parent'; 

    public const GUID = 'carbon_wp_posts.guid'; 

    public const MENU_ORDER = 'carbon_wp_posts.menu_order'; 

    public const POST_TYPE = 'carbon_wp_posts.post_type'; 

    public const POST_MIME_TYPE = 'carbon_wp_posts.post_mime_type'; 

    public const COMMENT_COUNT = 'carbon_wp_posts.comment_count'; 
    ...
    **/
    public const PDO_VALIDATION = [
        self::ID => [ self::MYSQL_TYPE => 'bigint unsigned', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => true, self::SKIP_COLUMN_IN_POST => true ],
        self::POST_AUTHOR => [ self::MYSQL_TYPE => 'bigint unsigned', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0"' ],
        self::POST_DATE => [ self::MYSQL_TYPE => 'datetime', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0000-00-00 00:00:00"' ],
        self::POST_DATE_GMT => [ self::MYSQL_TYPE => 'datetime', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0000-00-00 00:00:00"' ],
        self::POST_CONTENT => [ self::MYSQL_TYPE => 'longtext', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::POST_TITLE => [ self::MYSQL_TYPE => 'text', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::POST_EXCERPT => [ self::MYSQL_TYPE => 'text', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::POST_STATUS => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '20', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"publish"' ],
        self::COMMENT_STATUS => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '20', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"open"' ],
        self::PING_STATUS => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '20', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"open"' ],
        self::POST_PASSWORD => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '255', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::POST_NAME => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '200', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::TO_PING => [ self::MYSQL_TYPE => 'text', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::PINGED => [ self::MYSQL_TYPE => 'text', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::POST_MODIFIED => [ self::MYSQL_TYPE => 'datetime', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0000-00-00 00:00:00"' ],
        self::POST_MODIFIED_GMT => [ self::MYSQL_TYPE => 'datetime', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0000-00-00 00:00:00"' ],
        self::POST_CONTENT_FILTERED => [ self::MYSQL_TYPE => 'longtext', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::POST_PARENT => [ self::MYSQL_TYPE => 'bigint unsigned', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0"' ],
        self::GUID => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '255', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::MENU_ORDER => [ self::MYSQL_TYPE => 'int', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0"' ],
        self::POST_TYPE => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '20', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"post"' ],
        self::POST_MIME_TYPE => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '100', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::COMMENT_COUNT => [ self::MYSQL_TYPE => 'bigint', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0"' ],
    ];
    ...
    **/
     ...
     *              ],
     *              self::ID => [
     *                  [self::class => 'disallowPublicAccess', self::ID]
     *              ],
     *              self::POST_AUTHOR => [
     *                  [self::class => 'disallowPublicAccess', self::POST_AUTHOR]
     *              ],
     *              self::POST_DATE => [
     *                  [self::class => 'disallowPublicAccess', self::POST_DATE]
     *              ],
     *              self::POST_DATE_GMT => [
     *                  [self::class => 'disallowPublicAccess', self::POST_DATE_GMT]
     *              ],
     *              self::POST_CONTENT => [
     *                  [self::class => 'disallowPublicAccess', self::POST_CONTENT]
     *              ],
     *              self::POST_TITLE => [
     *                  [self::class => 'disallowPublicAccess', self::POST_TITLE]
     *              ],
     *              self::POST_EXCERPT => [
     *                  [self::class => 'disallowPublicAccess', self::POST_EXCERPT]
     *              ],
     *              self::POST_STATUS => [
     *                  [self::class => 'disallowPublicAccess', self::POST_STATUS]
     *              ],
     *              self::COMMENT_STATUS => [
     *                  [self::class => 'disallowPublicAccess', self::COMMENT_STATUS]
     *              ],
     *              self::PING_STATUS => [
     *                  [self::class => 'disallowPublicAccess', self::PING_STATUS]
     *              ],
     *              self::POST_PASSWORD => [
     *                  [self::class => 'disallowPublicAccess', self::POST_PASSWORD]
     *              ],
     *              self::POST_NAME => [
     *                  [self::class => 'disallowPublicAccess', self::POST_NAME]
     *              ],
     *              self::TO_PING => [
     *                  [self::class => 'disallowPublicAccess', self::TO_PING]
     *              ],
     *              self::PINGED => [
     *                  [self::class => 'disallowPublicAccess', self::PINGED]
     *              ],
     *              self::POST_MODIFIED => [
     *                  [self::class => 'disallowPublicAccess', self::POST_MODIFIED]
     *              ],
     *              self::POST_MODIFIED_GMT => [
     *                  [self::class => 'disallowPublicAccess', self::POST_MODIFIED_GMT]
     *              ],
     *              self::POST_CONTENT_FILTERED => [
     *                  [self::class => 'disallowPublicAccess', self::POST_CONTENT_FILTERED]
     *              ],
     *              self::POST_PARENT => [
     *                  [self::class => 'disallowPublicAccess', self::POST_PARENT]
     *              ],
     *              self::GUID => [
     *                  [self::class => 'disallowPublicAccess', self::GUID]
     *              ],
     *              self::MENU_ORDER => [
     *                  [self::class => 'disallowPublicAccess', self::MENU_ORDER]
     *              ],
     *              self::POST_TYPE => [
     *                  [self::class => 'disallowPublicAccess', self::POST_TYPE]
     *              ],
     *              self::POST_MIME_TYPE => [
     *                  [self::class => 'disallowPublicAccess', self::POST_MIME_TYPE]
     *              ],
     *              self::COMMENT_COUNT => [
     *                  [self::class => 'disallowPublicAccess', self::COMMENT_COUNT]
     *              ],
     *          ],    

...
use Backend\Tables\Traits\Wp_Options_Columns;
...
class Wp_Options extends Rest implements iRestSinglePrimaryKey
{
    ...
    **/
    public const PRIMARY = 'carbon_wp_options.option_id';
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in carbon_wp_options. 
    ...
    **/
    public const OPTION_ID = 'carbon_wp_options.option_id'; 

    public const OPTION_NAME = 'carbon_wp_options.option_name'; 

    public const OPTION_VALUE = 'carbon_wp_options.option_value'; 

    public const AUTOLOAD = 'carbon_wp_options.autoload'; 
    ...
    **/
    public const PDO_VALIDATION = [
        self::OPTION_ID => [ self::MYSQL_TYPE => 'bigint unsigned', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => true, self::SKIP_COLUMN_IN_POST => true ],
        self::OPTION_NAME => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '191', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '""' ],
        self::OPTION_VALUE => [ self::MYSQL_TYPE => 'longtext', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => false ],
        self::AUTOLOAD => [ self::MYSQL_TYPE => 'varchar', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_STR, self::MAX_LENGTH => '20', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"yes"' ],
    ];
    ...
    **/
     ...
     *              ],
     *              self::OPTION_ID => [
     *                  [self::class => 'disallowPublicAccess', self::OPTION_ID]
     *              ],
     *              self::OPTION_NAME => [
     *                  [self::class => 'disallowPublicAccess', self::OPTION_NAME]
     *              ],
     *              self::OPTION_VALUE => [
     *                  [self::class => 'disallowPublicAccess', self::OPTION_VALUE]
     *              ],
     *              self::AUTOLOAD => [
     *                  [self::class => 'disallowPublicAccess', self::AUTOLOAD]
     *              ],
     *          ],    

...
use Backend\Tables\Traits\Wp_Postmeta_Columns;
...
class Wp_Postmeta extends Rest implements iRestSinglePrimaryKey
{
    ...
    **/
    public const PRIMARY = 'carbon_wp_postmeta.meta_id';
    ...
    **/
    ...
    /**
     * COLUMNS
     * The columns below are a 1=1 mapping to the columns found in carbon_wp_postmeta. 
    ...
    **/
    public const META_ID = 'carbon_wp_postmeta.meta_id'; 

    public const POST_ID = 'carbon_wp_postmeta.post_id'; 

    public const META_KEY = 'carbon_wp_postmeta.meta_key'; 

    public const META_VALUE = 'carbon_wp_postmeta.meta_value'; 
    ...
    **/
    public const PDO_VALIDATION = [
        ...
        self::POST_ID => [ self::MYSQL_TYPE => 'bigint unsigned', self::NOT_NULL => true, self::COLUMN_CONSTRAINTS => [], self::PDO_TYPE => PDO::PARAM_INT, self::MAX_LENGTH => '', self::AUTO_INCREMENT => false, self::SKIP_COLUMN_IN_POST => true, self::DEFAULT_POST_VALUE => '"0"' ],
    ...
    **/
     ...
     *              ],
     *              self::POST_ID => [
     *                  [self::class => 'disallowPublicAccess', self::POST_ID]
     *              ],
     *              self::META_KEY => [
